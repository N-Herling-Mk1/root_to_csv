console.log('root_to_csv site.js v35 loaded');
...
try {
const TERMS = [
["drop list","drop_list.txt — the plain-text file you author listing branch names to ignore. One name per line; # comments and blank lines skipped. Optional: no file = step 5 is a clean no-op. Matched against manifest.json branch names, never CSV column headers."],
